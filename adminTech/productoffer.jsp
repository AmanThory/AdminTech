    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="box-body">
               ...
               <h3 class="modal-title" id="myModalLabel">Add Offer</h3>
            </div>
            <div class="col-md-6">
              <!-- fee category feild -->
             <div class="form-group">
                  <label>Category ID</label>
                  <input type="text" name="ocatid" class="form-control" placeholder="Category ID">
                </div>
              <!-- /.form group -->
             ...
             <div class="form-group">
                  ...
                  <select class="form-control" name="ocat">
              ...
              <div class="form-group">
                <label>Discount</label>
                  <input type="text" name="odiscount" class="form-control" placeholder="Discount">
                </div>
                <!-- /.input group -->
              ...
              <div class="form-group">
               <label>Flat</label>
                  <input type="text" name="oflat" class="form-control" placeholder="Flat">
                </div>
                <!-- /.input group -->
				</div>
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label>Today's Deal</label>
                  <input type="text" name="otoday" class="form-control" placeholder="Today's Deal">
              </div>
                <!-- Discount -->
                 <div class="form-group">
                <label>Top Offers</label>
                  <input type="text" name="otop" class="form-control" placeholder="Top Offers">
              </div>
				</div>
				<div class="col-md-6">
              <!-- Status feild -->
			...
			<div class="box-footer">
                <button type="submit" class="btn btn-primary" name="proedit">Add Offer</button>
              </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="col-md-6">
             ...
             <div class="form-group">
                  <label>Category ID</label>
                  <input type="text" name="eocatid" class="form-control" placeholder="Category ID">
                </div>
              <!-- /.form group -->
             ...
             <div class="form-group">
                  <label>Category Name</label>
                  <select class="form-control" name="eocat">
                    <option selected="selected">--Category</option>
                    <option>Man</option>
                    <option>Woman</option>
                    <option>Kid</option>
              ...
              <div class="form-group">
                <label>Discount</label>
                  <input type="text" name="eodiscount" class="form-control" placeholder="Discount">
                </div>
                <!-- /.input group -->
              ...
              <div class="form-group">
               <label>Flat</label>
                  <input type="text" name="eoflat" class="form-control" placeholder="Flat">
                </div>
                <!-- /.input group -->
				</div>
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label>Today's Deal</label>
                  <input type="text" name="eotoday" class="form-control" placeholder="Today's Deal">
              </div>
                <!-- Discount -->
                 <div class="form-group">
                <label>Top Offers</label>
                  <input type="text" name="eotop" class="form-control" placeholder="Top Offers">
              </div>
				</div>
				<div class="col-md-6">
              <!-- Status feild -->
              ...
              <!-- /.form group -->
			<div class="box-footer">
                <button type="submit" class="btn btn-primary" name="proedit">Edit Offer</button>
              </div>
					        ...
					        <table id="demo-custom-toolbar" class="demo-add-niftycheck" data-toggle="table"
					            ...
					            <thead>
					                <tr>
										...
										<th  data-align="center" data-sortable="true">Category ID</th>
					                    <th  data-align="center" data-sortable="true">Category Name</th>
										<th  data-align="center" data-sortable="true">Discount</th>
										<th  data-align="center" data-sortable="true">Flat</th>
					                    <th  data-align="center" data-sortable="true">Today's Deal</th>
										<th  data-align="center" data-sortable="true">Top Offers</th>
					                </tr>
