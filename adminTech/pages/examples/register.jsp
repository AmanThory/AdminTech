...
<div class="register-box">
  <div class="register-logo">
    <a href="../../index2.jsp"><b>OneTech</b>Admin</a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Register a new membership</p>

    <form action="<%=request.getContextPath() %>/RegisterAction" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="number" class="form-control" name="number" placeholder="Retype number">
