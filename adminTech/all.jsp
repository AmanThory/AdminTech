<%@ page languag="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="allcat.jsp"><i class="fa fa-circle-o"></i> All Category</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
      ...
      <div class="modal-body">
            ...
            <div class="col-md-6">
              ...
              <!-- /.form group -->
                ...
                <button type="submit" class="btn btn-primary" name="add_fee_plane">Add Product</button>
              </div>
					        ...
					        <table id="demo-custom-toolbar" class="demo-add-niftycheck" data-toggle="table"
					            ...
					            <thead>
					                <tr>
										...
										<th  data-align="center" data-sortable="true">Shop Name</th>
