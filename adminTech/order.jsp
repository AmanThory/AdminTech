    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="box-body">
               ...
               <h3 class="modal-title" id="myModalLabel">Add Order</h3>
            </div>
            <div class="col-md-6">
              <!-- fee category feild -->
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
               ...
               <!-- Amount -->
              <div class="form-group">
                <label>Grand Total(Base)</label>
                  <input type="text" name="poffer" class="form-control" placeholder="Grand Total(Base)">
             </div>
 
            <div class="form-group">
                <label>Grand Total(Purchase)</label>
                  <input type="text" name="poffer" class="form-control" placeholder="Grand Total(Purchase)">
             </div>        
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary" name="proadd">Add Order</button>
              </div>
            </div>            </form>
					        ...
					        <table id="demo-custom-toolbar" class="demo-add-niftycheck" data-toggle="table"
					            ...
					            <thead>
					                <tr>
					                    ...
					                    <th  data-align="center" data-sortable="true">Purchase Point</th>
