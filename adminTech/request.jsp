  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Shop Requests</li>
      </ol>
    </section>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document" style="width: 375px">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="box-body">
               ...
               <h3 class="modal-title" id="myModalLabel">Add Products</h3>
            </div>
                 <!-- fee id feild -->
             <div class="form-group">
                  <label>Product Name</label>
                  <input type="text" name="add_fee_id" class="form-control" placeholder="Product Name">
                </div>
              <!-- /.form group -->
              <!-- fee category feild -->
			  <div class="form-group">
                <label>Category</label>
                <select name="add_status" class="form-control select2" style="width: 100%;">
             ...
             <div class="form-group">
                  <label>Price</label>
                  <input type="text" name="add_fee_category" class="form-control" placeholder="Price">
                </div>
              
                <!-- Invoice pre fix field -->
              <div class="form-group">
                  <label>Quantity</label>
                  <input type="text" name="add_fee_id" class="form-control" placeholder="Quantity">
                </div><!-- /.form group -->

              <!--Description -->
              <div class="form-group">
                  <label>Stock</label>
                  <input type="text" name="add_fee_id" class="form-control" placeholder="Stock">
                </div>
              <!-- /.form group -->

              <!-- Fee Category Status feild -->
              <div class="form-group">
                  <label>Offer</label>
                  <input type="text" name="add_fee_id" class="form-control" placeholder="Offer">
                </div>
              <!-- /.form group -->
			  <div class="form-group ">
					        ...
					        <table id="demo-custom-toolbar" class="demo-add-niftycheck" data-toggle="table"
					            ...
					            <thead>
					                <tr>
					                    ...
					                    <th  data-align="center" data-sortable="true">Shop Number</th>
					                    <th  data-align="center" data-sortable="true">Address</th>
										<th  data-align="center" data-sortable="true">City</th>
					                    <th  data-align="center" data-sortable="true">State</th>
					                    <th  data-align="center" data-sortable="true">Type Of Business</th>
										<th  data-align="center" data-sortable="true">GST Number</th>
										<th  data-align="center" data-sortable="true">TIN Number</th>
					                    <th  data-align="center" data-sortable="true">PAN</th>
					                    <th  data-align="center" data-sortable="true">Action</th>
