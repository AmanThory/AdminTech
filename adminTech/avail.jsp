    ...
    <div class="modal-content">
      ...
      <div class="modal-body" >
            ...
            <div class="box-body">
               ...
               <h3 class="modal-title" id="myModalLabel">Add Stock</h3>
            </div>
            <div class="col-md-6">
              <!-- fee category feild -->
             <div class="form-group">
                  <label>ID</label>
                  <input type="text" name="availcat" class="form-control" placeholder="ID">
                </div>    
             <div class="form-group">
                  <label>Category</label>
                  <input type="text" name="availcat" class="form-control" placeholder="Category">
                </div>
              <!-- /.form group -->               
			</div>
                ...
                <div class="form-group">
                  <label>Stock</label>
				  <input type="text" name="availstock" class="form-control" placeholder="Stock">
                </div>

                <!-- Date range -->
              <div class="form-group">
                <label>Quantity</label>
                  <input type="text" name="availquantity" class="form-control" placeholder="Quantity">
                </div>
                <!-- /.input group -->
			...
			<div class="box-footer">
                <button type="submit" class="btn btn-primary" name="proedit">Add Stock</button>
              </div>
